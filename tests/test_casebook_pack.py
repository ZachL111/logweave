"""Regression checks for the logweave casebook."""
...
from casebook.harness import assert_expected, logweave_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(logweave_summary(), assert_expected())
