...
`logweave` is centered on observability work in Rust. The technical target is: Correlate service logs into incident timelines.
...
The score is deterministic. The current threshold is 171. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 5.
